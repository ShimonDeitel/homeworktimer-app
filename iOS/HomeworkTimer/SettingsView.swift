...
struct SettingsView: View {
    ...
    @AppStorage("homeworktimer_notifyEnabled") private var notifyEnabled = true
    @AppStorage("homeworktimer_iCloudSyncEnabled") private var iCloudSyncEnabled = false
    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                Section("About") {
                    Link("Privacy Policy", destination: URL(string: "https://shimondeitel.github.io/homeworktimer-app/privacy.html")!)
                    Text("Version 1.0")
